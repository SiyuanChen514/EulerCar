...
: ${AMENT_CURRENT_PREFIX:="/root/autonomous_explorer_ws_new/install/servo_response"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/servo_response/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/servo_response/environment/path.sh"
